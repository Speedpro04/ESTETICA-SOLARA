            ...
            <>
              ...
              {resetSent ? (
                <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} style={{ textAlign: 'center', width: '100%' }}>
                  ...
                  <button onClick={() => { setShowResetForm(false); setResetSent(false); }} style={{ width: '100%', background: `linear-gradient(to right, ${colors.cyan}, #00a8ff)`, border: 'none', padding: '16px', borderRadius: 3, color: '#ffffff', fontWeight: 700, fontSize: '1rem', cursor: 'pointer' }}>
                    Voltar ao Login
                  </button>
                </motion.div>
              ) : (
